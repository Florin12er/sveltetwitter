<script lang="ts">
	...
	const mockTweets = [
		...
		},
		{
			id: 't2',
			username: '@janedoe',
			content: "Working on a new project. Can't wait to share it! 🚀 #Coding",
			likes: 20,
			retweets: 8
		},
		{
			id: 't3',
			username: '@techguru',
			content: "The future of AI is here, and it's mind-blowing! 🤖 #ArtificialIntelligence",
			likes: 50,
			retweets: 25
		}
	];
	...
	const mockUsers = [
		...
		},
		{
			...
			bio: 'Full-stack developer and cat lover',
			followers: 200,
			following: 100
		},
		{
			...
			bio: 'AI researcher and futurist',
			followers: 300,
			following: 150
		}
	];
	...
	function isTweet(
		result: (typeof mockTweets)[number] | (typeof mockUsers)[number]
	): result is (typeof mockTweets)[number] {
